...
public class JobTest {
    ...
    private final List<Job> jobs = new ArrayList<>(List.of(bug1, bug4, bug2, task0));

    @Test
    public void whenComparatorDescByNameAndDescByPriority() {
        Collections.sort(jobs, new JobDescByName().thenComparing(new JobDescByPriority()));
        List<Job> expected = new ArrayList<>(List.of(task0, bug4, bug2, bug1));
    ...
    public void whenComparatorDescByNameAndAscByPriority() {
        ...
        List<Job> expected = new ArrayList<>(List.of(task0, bug1, bug2, bug4));
        Assert.assertEquals(expected, jobs);
    }
    ...
    public void whenComparatorAscByNameAndDescByPriority() {
        ...
        List<Job> expected = new ArrayList<>(List.of(bug4, bug2, bug1, task0));
        Assert.assertEquals(expected, jobs);
    }
    ...
    public void whenComparatorAscByNameAndAscByPriority() {
        ...
        List<Job> expected = new ArrayList<>(List.of(bug1, bug2, bug4, task0));
        Assert.assertEquals(expected, jobs);
    }
    ...
    public void whenComparatorDescBy() {
        ...
        List<Job> expected = new ArrayList<>(List.of(task0, bug1, bug4, bug2));
        Assert.assertEquals(expected, jobs);
    }
    ...
    public void whenComparatorAscByName() {
        ...
        List<Job> expected = new ArrayList<>(List.of(bug1, bug4, bug2, task0));
        Assert.assertEquals(expected, jobs);
    }
